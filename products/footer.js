                                ...
                                <ul class="post-widget-wrap">
                                    <li class="post-item">
                                        ...
                                        <div class="post-title-date">
                                            <h3 class="title"><a href="product-detail.html?product=Crude%20Palm%20Oil%20(CPO)">Crude Palm Oil (CPO)</a></h3>
                                    ...
                                    <li class="post-item">
                                        ...
                                        <div class="post-title-date">
                                            <h3 class="title"><a href=product-detail.html?product=Palm%20Kernel%20Oil%20(PKO)">Palm Kernel Oil (PKO)</a></h3>
                                            <span class="posted-on"><i class="fas fa-check-circle"></i><a href="#">Downstream</a></span>
                                        </div>
                                    </li>
                                </ul>
                                <a href="" class="more-btn">See More Products</a>
                            </div>
                        </div>
                    </div>
                </div>
